...
<body>
  ...
  <header id="header" class="fixed-top ">
    <div class="container d-flex align-items-center">
      ...
      <h1 class="logo me-auto"><a href="index.html">HR Management</a></h1>
      <!-- Uncomment below if you prefer to use an image logo -->
      <!-- <a href="index.html" class="logo me-auto"><img src="/static/assets/img/logo.png" alt="" class="img-fluid"></a>-->

      <nav id="navbar" class="navbar">
        <ul>
          <li><a class="nav-link scrollto active" href="traineehome.php">Home</a></li>

                      <li><a class="nav-link scrollto" href="trainee_profile.php">Profile</a></li>
          <li><a class="nav-link scrollto" href="trainee_viewwork.php"> Work</a></li>

           <li><a class="nav-link scrollto" href="trainee_notification.php">  Notification</a></li>
          <li><a class="nav-link scrollto" href="trainee_addfeedback.php">Send Feedback</a></li>
