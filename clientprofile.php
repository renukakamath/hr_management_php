...
if (isset($_POST['update'])) {
    ...
    echo$q="update client set firstname='$fname',lastname='$lname',place='$place',phone='$phone',email='$email' where client_id='$client_id'";
    update($q);
alert('updation successfully');
   return redirect('clientprofile.php');
}
